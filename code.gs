...
function createUsersSheet() {
  ...
  // Headers
  const headers = ['id', 'username', 'password', 'name', 'role', 'department', 'pin'];
  
  // Sample data
  const sampleData = [
    [1, '', '', 'สมชาย ใจดี', 'user', 'D1', '1111'], // Example PIN
    [2, '', '', 'สมหญิง รักดี', 'admin', 'D1', '2222'],
    [3, '', '', 'สมศักดิ์ ทำงานดี', 'user', 'D2', '3333'],
    [4, '', '', 'สมใจ คิดดี', 'user', 'D2', '4444'],
    [5, '', '', 'ผู้จัดการ ฝ่ายจัดซื้อ', 'admin', 'D3', '5555'],
    [6, '', '', 'พนักงาน คลังสินค้า', 'user', 'D3', '6666'],
    [7, '', '', 'หัวหน้า ฝ่ายการเงิน', 'user', 'D4', '7777'],
    [8, '', '', 'เจ้าหน้าที่ บัญชี', 'user', 'D4', '8888']
  ];
