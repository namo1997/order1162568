...
// Configuration
const SPREADSHEET_ID = '1wv6KKosOPC-yvYkNyMv0rXBYtfk4wGGn6MhCVt5xMQM'; // ใส่ ID ของ Google Sheet
...
function createUsersSheet() {
  ...
  // Headers
  const headers = ['id', 'username', 'password', 'name', 'role', 'department', 'branch', 'pin'];
  
  // Sample data
  const sampleData = [
    [1, '', '', 'สมชาย ใจดี', 'user', 'D1', 'B1', '1111'],
    [2, '', '', 'สมหญิง รักดี', 'admin', 'D1', 'B1', '2222'],
    [3, '', '', 'สมศักดิ์ ทำงานดี', 'user', 'D2', 'B2', '3333'],
    [4, '', '', 'สมใจ คิดดี', 'user', 'D2', 'B2', '4444'],
    [5, '', '', 'ผู้จัดการ ฝ่ายจัดซื้อ', 'admin', 'D3', 'B1', '5555'],
    [6, '', '', 'พนักงาน คลังสินค้า', 'user', 'D3', 'B3', '6666'],
    [7, '', '', 'หัวหน้า ฝ่ายการเงิน', 'user', 'D4', 'B3', '7777'],
    [8, '', '', 'เจ้าหน้าที่ บัญชี', 'user', 'D4', 'B4', '8888']
  ];
...
function createProductsSheet() {
  ...
  const headers = ['id', 'name', 'description', 'unit', 'category', 'icon', 'imageUrl'];
  const sampleData = [
    // อุปกรณ์สำนักงาน
    ['P001', 'กระดาษ A4', '80 แกรม 500 แผ่น', 'รีม', 'C1', '📄', ''], // ใส่ URL รูปภาพที่นี่
